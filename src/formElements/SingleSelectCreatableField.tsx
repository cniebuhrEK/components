...
import { SingleSelectCreatable } from '../components'

interface SingleSelectCreatableFieldProps {
  name: string
  required: boolean
...
export const SingleSelectCreatableField = (
  props: SingleSelectCreatableFieldProps
): JSX.Element => {
  const {
    disabled,
    options,
...
SingleSelectCreatableField.defaultProps = {
  name: '',
  label: '',
  disabled: false,
  required: false,
...
export default SingleSelectCreatableField
